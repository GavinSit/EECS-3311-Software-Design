...
extern void F1672_18964(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1672_18965(EIF_REFERENCE);
extern void F1672_18966(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1672_18967(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1672_18968(EIF_REFERENCE);
extern void F1672_18969(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1672_18970_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1672_18970(EIF_REFERENCE);
...
void F1672_18964 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1671, Current, 0, 1, 25507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25507);
	RTCC(arg1, 1671, l_feature_name, 1, RTWCT(15654, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1672_18965 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1671, Current, 0, 0, 25508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25508);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1672_18966 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1671, Current, 0, 0, 25509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25509);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1672_18967 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1671, Current, 1, 0, 25510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25510);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	...
	if (tb1) {
		...
		if (tb1) {
			RTHOOK(4);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9277, dtype))(Current);
			RTHOOK(5);
		...
		RTHOOK(6);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9281, dtype))(Current);
	}
	RTHOOK(7);
...
EIF_TYPED_VALUE F1672_18968 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1671, Current, 0, 0, 25511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25511);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9280, dtype))(Current, ur1x);
...
void F1672_18969 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1671, Current, 2, 1, 25512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25512);
	RTCC(arg1, 1671, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	loc1 = RTLN(eif_new_type(1569, 0x01).id);
	...
	loc1 = RTRV(eif_new_type(1861, 0x00), tr2);
	RTHOOK(3);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(18321, "silly_main_window", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
	...
	if (tb1) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(10);
			ur1 = RTCCL(arg1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9279, dtype))(Current, ur1x);
		}
		RTHOOK(11);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9281, dtype))(Current);
	}
	if (RTAL & CK_ENSURE) {
		...
		tb1 = '\0';
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15839, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(12,1);
		ur1 = RTCCL(arg1);
...
static EIF_TYPED_VALUE F1672_18970_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1671, Current, 0, 0, 25513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1671, Current, 25513);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1672_18970 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15654, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1672_18970_body (Current)).it_r;
