...
extern EIF_TYPED_VALUE F1643_18583(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1643_18583 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14776, 0xF80006DB, 0); /* implementation */
