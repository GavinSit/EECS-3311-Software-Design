...
extern EIF_TYPED_VALUE F1619_18399(EIF_REFERENCE);
extern void F1619_18400(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1619_18399 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1619_18400 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1618, Current, 0, 0, 25059);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1618, Current, 25059);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14776, 0xF80006C3, 0); /* implementation */
