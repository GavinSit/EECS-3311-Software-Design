...
extern EIF_TYPED_VALUE F1630_18525(EIF_REFERENCE);
extern void F1630_18526(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1630_18525 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1630_18526 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1629, Current, 0, 0, 25188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1629, Current, 25188);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14776, 0xF80006D2, 0); /* implementation */
