...
extern EIF_TYPED_VALUE F1351_14275(EIF_REFERENCE);
...
RTOID (F1351_14275)
EIF_TYPED_VALUE F1351_14275 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1350, Current, 0, 0, 20802);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800056C, 0,0); /* Result */
