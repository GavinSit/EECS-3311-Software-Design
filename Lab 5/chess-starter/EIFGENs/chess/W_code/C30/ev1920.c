...
extern void F1920_23724(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1920_23725(EIF_REFERENCE);
extern void F1920_23726(EIF_REFERENCE);
extern void F1920_23727(EIF_REFERENCE);
extern void F1920_23728(EIF_REFERENCE);
static EIF_TYPED_VALUE F1920_23729_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1920_23729(EIF_REFERENCE);
...
void F1920_23724 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1919, Current, 0, 0, 29665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1919, Current, 29665);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15649, 1916))(Current);
	RTHOOK(2);
...
EIF_TYPED_VALUE F1920_23725 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1920_23726 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1919, Current, 1, 0, 29667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1919, Current, 29667);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19402, dtype))(Current);
	RTHOOK(2);
	...
	if (EIF_TEST(loc1)) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(18830, "check_button", loc1))(loc1, ui4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("selected", EX_POST);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(19403, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1920_23727 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1919, Current, 1, 0, 29668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1919, Current, 29668);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19403, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19403, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	...
	if (EIF_TEST(loc1)) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(10857, dtype));
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(18831, "uncheck_button", loc1))(loc1, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F1920_23728 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1919, Current, 2, 0, 29669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1919, Current, 29669);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			if (!RTCEQ(tr1, Current)) {
				...
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(7,1);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19401, "disable_select", tr1))(tr1);
			}
			RTHOOK(8);
...
static EIF_TYPED_VALUE F1920_23729_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1919, Current, 0, 0, 29670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1919, Current, 29670);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1920_23729 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15654, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1920_23729_body (Current)).it_r;
