...
extern EIF_TYPED_VALUE F2012_19168(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2012_19169(EIF_REFERENCE);
extern void F2012_19170(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F2012_19171(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F2012_19168 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2011, Current, 2, 1, 25675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2011, Current, 25675);
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(RTWCT(15985, dtype, Dftype(Current)),loc2);
		tb1 = EIF_TEST(loc2);
	}
	if (tb1) {
		RTCK0;
...
EIF_TYPED_VALUE F2012_19169 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2011, Current, 0, 0, 25676);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2011, Current, 25676);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F2012_19170 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2011, Current, 1, 2, 25677);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2011, Current, 25677);
	RTCC(arg1, 2011, l_feature_name, 1, RTWCT(15985, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
body:;
	...
	loc1 = RTCCL(tr2);
	loc1 = RTRV(RTWCT(16021, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTCK0;
	} else {
		RTCF0;
...
void F2012_19171 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2011, Current, 0, 1, 25678);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2011, Current, 25678);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
