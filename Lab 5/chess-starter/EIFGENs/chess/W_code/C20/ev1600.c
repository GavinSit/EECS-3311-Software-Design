...
extern EIF_TYPED_VALUE F1600_18147(EIF_REFERENCE);
extern void F1600_18148(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1600_18147 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1600_18148 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1599, Current, 0, 0, 24807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1599, Current, 24807);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14776, 0xF80006B2, 0); /* implementation */
