...
extern EIF_TYPED_VALUE F1091_10573(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1091_10574(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1091_10575(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1091_10573 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1090, Current, 0, 0, 16917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1090, Current, 16917);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1091_10574 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1090, Current, 0, 0, 16918);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1090, Current, 16918);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1091_10575 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1090, Current, 0, 1, 16919);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1090, Current, 16919);
	RTIV(Current, RTAL);
	RTHOOK(1);
