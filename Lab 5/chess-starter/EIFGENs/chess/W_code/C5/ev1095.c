...
extern EIF_TYPED_VALUE F1095_10589(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1095_10589 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1094, Current, 3, 0, 16932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 16932);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16744, "vertical_resolution", loc1))(loc1)).it_i4);
	RTNHOOK(2,1);
	...
	if (tb1) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(19286, "dc", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
