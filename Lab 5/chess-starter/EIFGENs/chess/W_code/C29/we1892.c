...
extern void F1892_23023(EIF_REFERENCE);
extern void F1892_23024(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1892_23025(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1892_23026(EIF_REFERENCE);
...
void F1892_23023 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1891, Current, 0, 0, 28987);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 28987);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19082, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1892_23024 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1891, Current, 0, 0, 28988);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 28988);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
EIF_TYPED_VALUE F1892_23025 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1891, Current, 0, 0, 28989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 28989);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
RTOID (F1892_23026)
EIF_TYPED_VALUE F1892_23026 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1892_23026);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1891, Current, 0, 0, 28990);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 28990);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10713, dtype))(Current)).it_i4);
