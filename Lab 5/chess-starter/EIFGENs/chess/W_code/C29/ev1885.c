...
extern EIF_TYPED_VALUE F1885_22867(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1885_22868(EIF_REFERENCE);
extern void F1885_22869(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1885_22870(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1885_22871(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1885_22867 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1884, Current, 1, 0, 28831);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1884, Current, 28831);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1885_22868 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1884, Current, 1, 0, 28832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1884, Current, 28832);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1885_22869 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1884, Current, 0, 1, 28833);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1884, Current, 28833);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		if (tb1) {
			RTHOOK(4);
			RTDBGAA(Current, dtype, 18976, 0xF80000EE, 0); /* internal_text */
			...
			tr1 = RTCCL(tr2);
			RTAR(Current, tr1);
			*(EIF_REFERENCE *)(Current + RTWA(18976, dtype)) = (EIF_REFERENCE) tr1;
		} else {
			RTHOOK(5);
			RTDBGAA(Current, dtype, 18976, 0xF80000EE, 0); /* internal_text */
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4701, "as_string_32", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 18976, 0xF80000EE, 0); /* internal_text */
		*(EIF_REFERENCE *)(Current + RTWA(18976, dtype)) = (EIF_REFERENCE) NULL;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1885_22870 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(18976,Dtype(Current)));
	return r;
}
...
RTOID (F1885_22871)
EIF_TYPED_VALUE F1885_22871 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1885_22871);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1884, Current, 0, 0, 28835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1884, Current, 28835);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18552, 1883))(Current)).it_i4);
