...
extern void F1157_25508(EIF_REFERENCE, int);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(9416, dtype)) = (EIF_BOOLEAN) tb1;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 9415, 0xF800056F, 0); /* file */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1157_25508 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1156, Current, 0, 25507);
	RTSA(dtype);
	RTME(dtype, 0);
