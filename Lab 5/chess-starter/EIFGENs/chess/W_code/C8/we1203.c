...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1202, Current, 18568);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1202, Current, 0, 0, 18570);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1202, Current, 18570);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,0xFF01,1869,0xFFFF};
		EIF_TYPE typres0;
	...
	tr2 = RTLN(eif_new_type(1869, 0x01).id);
	tr3 = RTMS_EX_H("WEL Silly Window",16,787402615);
	ur1 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(18738, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
