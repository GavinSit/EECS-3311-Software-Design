...
extern void F1248_12930(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ARRAY_ARG}.make */
void F1248_12930 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1247, Current, 0, 1, 19177);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10643, 0xF80000E8, 0); /* src_out */
	tr1 = RTLNSMART(RTWCT(10643, dtype, Dftype(Current)).id);
	...
	*(EIF_REFERENCE *)(Current + RTWA(10643, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10645, 0xF80000F8, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10645, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1247, Current, 1, 0, 19178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10645, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10643, "src_out", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tb2 = *(EIF_BOOLEAN *)(loc4 + RTVA(10665, "value", loc4));
			ub1 = tb2;
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti8_1 = *(EIF_INTEGER_64 *)(loc4 + RTVA(10655, "value", loc4));
			ui8_1 = ti8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2663, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti4_1 = *(EIF_INTEGER_32 *)(loc4 + RTVA(10657, "value", loc4));
			ui4_1 = ti4_1;
			ti4_2 = *(EIF_INTEGER_32 *)(Result + RTVA(2663, "upper", Result));
			ui4_2 = (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 1L));
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2638, "force", Result))(Result, ui4_1x, ui4_2x);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr8_1 = *(EIF_REAL_64 *)(loc4 + RTVA(10667, "value", loc4));
			ur8_1 = tr8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2663, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10661, "value", loc4))(loc4)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2663, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
