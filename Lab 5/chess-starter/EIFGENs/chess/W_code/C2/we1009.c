...
extern void F1009_9253(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1009_9253 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1008, Current, 0, 1, 15556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1008, Current, 15556);
	if (arg1) {
		RTCC(arg1, 1008, l_feature_name, 1, eif_new_type(1804, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7038, 0xF800070C, 0); /* message_information */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
