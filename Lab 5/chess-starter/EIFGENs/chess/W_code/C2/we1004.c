...
#define ui4_4 ui4_4x.it_i4
	...
	RTCC(arg1, 1003, l_feature_name, 1, eif_new_type(1441, 0x01), 0x01);
	RTCC(arg2, 1003, l_feature_name, 2, eif_new_type(1413, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(12916, "height", arg1))(arg1)).it_i4);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTCC(arg1, 1003, l_feature_name, 1, eif_new_type(1427, 0x01), 0x01);
	RTCC(arg2, 1003, l_feature_name, 2, eif_new_type(1431, 0x01), 0x01);
	RTCC(arg3, 1003, l_feature_name, 3, eif_new_type(1413, 0x01), 0x01);
	RTCC(arg6, 1003, l_feature_name, 6, eif_new_type(1780, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11580, "exists", arg3))(arg3)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTHOOK(7);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(12734, "log_bitmap", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(9);
	tb1 = '\0';
	tb2 = '\0';
	if ((EIF_BOOLEAN) !arg7) {
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(13458, "bits_pixel", loc1))(loc1)).it_i4);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTCC(arg1, 1003, l_feature_name, 1, eif_new_type(1431, 0x01), 0x01);
	RTCC(arg2, 1003, l_feature_name, 2, eif_new_type(1413, 0x01), 0x01);
	RTCC(arg5, 1003, l_feature_name, 5, eif_new_type(1780, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	ur1 = RTCCL(tr1);
	ur2 = RTCCL(loc3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(12484, "fill_rect", loc1))(loc1, ur1x, ur2x);
	RTHOOK(14);
	...
	ui4_7 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(12497, "bit_blt", arg2))(arg2, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ur1x, ui4_5x, ui4_6x, ui4_7x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(18);
	RTDBGLE;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTCC(arg1, 1003, l_feature_name, 1, eif_new_type(981, 0x01), 0x01);
	RTCC(arg2, 1003, l_feature_name, 2, eif_new_type(981, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		for (;;) {
			...
			ui4_1 = loc3;
			ui4_2 = loc2;
			tr4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6736, "m", arg1))(arg1, ui4_1x, ui4_2x)).it_r4);
			ur4_1 = tr4_1;
			ui4_1 = loc3;
		...
		for (;;) {
			...
			for (;;) {
				...
				ui4_1 = loc1;
				ui4_2 = loc3;
				tr4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6736, "m", arg2))(arg2, ui4_1x, ui4_2x)).it_r4);
				ui4_1 = loc3;
			...
			ui4_1 = loc1;
			ui4_2 = loc2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6733, "set_m", Result))(Result, ur4_1x, ui4_1x, ui4_2x);
			RTHOOK(19);
			RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		}
