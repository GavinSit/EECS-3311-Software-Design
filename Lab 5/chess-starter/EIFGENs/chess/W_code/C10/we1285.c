...
extern EIF_TYPED_VALUE F1285_13260(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1285_13264(EIF_REFERENCE);
...
RTOID (F1285_13260)
EIF_TYPED_VALUE F1285_13260 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1284, Current, 0, 0, 19491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN) (ti4_1 < ti4_2)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11734, "set_string_with_newline_conversion", Result))(Result, ur1x);
	} else {
		RTHOOK(5);
		RTDBGAL(0, 0xF800052C, 0,0); /* Result */
		tr1 = RTLN(eif_new_type(1324, 0x01).id);
...
EIF_TYPED_VALUE F1285_13264 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
