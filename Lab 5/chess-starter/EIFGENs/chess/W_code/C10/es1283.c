...
extern void F1283_13251(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1283_13252(EIF_REFERENCE);
...
void F1283_13251 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1282, Current, 0, 2, 19482);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10932, 0xF8000383, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F1283_13252 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1282, Current, 3, 0, 19483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1283_13253 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1282, Current, 0, 0, 19484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
