...
extern EIF_TYPED_VALUE F1778_20215(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1778_20215 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1777, Current, 0, 0, 26316);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1777, Current, 26316);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80006F1, 0,0); /* Result */
