...
extern void F2023_3561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2023_3562(EIF_REFERENCE);
extern void F2023_3563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2023_3564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2023_3565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2023_3566(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2023_3567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2023_3568(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F2023_3561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2022, Current, 1, 1, 20434);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20434);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F2023_3562 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2022, Current, 1, 0, 20435);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20435);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F2023_3563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2022, Current, 0, 1, 20436);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20436);
	RTCC(arg1, 2022, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F2023_3564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2022, Current, 0, 1, 20437);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20437);
	RTCC(arg1, 2022, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F2023_3565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2022, Current, 0, 1, 20430);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20430);
	RTCC(arg1, 2022, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F2023_3566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2022, Current, 0, 0, 20431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20431);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2023_3567 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2022, Current, 1, 0, 20432);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20432);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2023_3568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2022, Current, 3, 1, 20433);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2022, Current, 20433);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
