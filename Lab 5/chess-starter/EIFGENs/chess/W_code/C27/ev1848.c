...
extern EIF_TYPED_VALUE F1848_21865(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1848_21866(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1848_21867(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1848_21868(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1848_21865 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1847, Current, 1, 0, 27846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1847, Current, 27846);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1848_21866 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1847, Current, 1, 0, 27847);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1847, Current, 27847);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF80006F4, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1780, 0x01).id);
...
EIF_TYPED_VALUE F1848_21867 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1847, Current, 1, 0, 27848);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1847, Current, 27848);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF80006F4, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1780, 0x01).id);
...
EIF_TYPED_VALUE F1848_21868 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1847, Current, 1, 0, 27849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1847, Current, 27849);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF80006F4, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1780, 0x01).id);
