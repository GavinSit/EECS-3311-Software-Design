...
extern EIF_TYPED_VALUE F1821_20971(EIF_REFERENCE);
...
RTOID (F1821_20971)
EIF_TYPED_VALUE F1821_20971 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1821_20971);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1820, Current, 0, 0, 26965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1820, Current, 26965);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
