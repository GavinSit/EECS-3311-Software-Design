...
extern void F1793_20603(EIF_REFERENCE);
extern void F1793_20604(EIF_REFERENCE);
...
void F1793_20603 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1792, Current, 0, 0, 26650);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1792, Current, 26650);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1793_20604 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1792, Current, 0, 0, 26651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1792, Current, 26651);
	RTIV(Current, RTAL);
