...
extern EIF_TYPED_VALUE F1798_20635(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1798_20636(EIF_REFERENCE);
extern void F1798_20637(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1798_20635 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1798_20636 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1798_20637 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1797, Current, 0, 0, 26678);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1797, Current, 26678);
	RTIV(Current, RTAL);
