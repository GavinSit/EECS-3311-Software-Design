...
extern EIF_TYPED_VALUE F986_8977(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F986_8977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 1, 15278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 15278);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case -1L:
