...
static EIF_INTEGER_32 inline_F961_7225 (void)
{
	{
...
static EIF_NATURAL_64 inline_F961_7226 (EIF_POINTER arg1)
{
	{
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5014, 0xF80000AB, 0); /* item */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13522);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(960, Current, 13522);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F961_7225 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(960, Current, 13524);
	RTIV(Current, RTAL);
	Result = inline_F961_7225 ();
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
...
#define arg1 arg1x.it_p
	...
	RTIV(Current, RTAL);
	Result = inline_F961_7226 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
