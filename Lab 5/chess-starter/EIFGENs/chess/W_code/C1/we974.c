...
extern void F974_8861(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F974_8861 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTCC(arg1, 973, l_feature_name, 1, eif_new_type(993, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6652, 0xF80003E1, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 973, Current, 2, 0, 15164);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
