...
extern void F1697_19422(EIF_REFERENCE);
static EIF_TYPED_VALUE F1697_19424_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1697_19424(EIF_REFERENCE);
...
void F1697_19422 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1696, Current, 0, 0, 25867);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1696, Current, 25867);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16220, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1697_19424_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1696, Current, 0, 0, 25868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1696, Current, 25868);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1697_19424 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15654, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1697_19424_body (Current)).it_r;
