...
extern EIF_TYPED_VALUE F1703_19445(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1703_19445 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1702, Current, 0, 0, 25878);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1702, Current, 25878);
	RTIV(Current, RTAL);
	RTHOOK(1);
