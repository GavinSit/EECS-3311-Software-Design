...
extern EIF_TYPED_VALUE F1693_19406(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1693_19407(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1693_19408(EIF_REFERENCE);
extern void F1693_19409(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1693_19410(EIF_REFERENCE);
extern void F1693_19411(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1693_19406 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1692, Current, 2, 0, 25853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16207, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1693_19407 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1692, Current, 3, 0, 25854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16207, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
				RTDBGAL(2, 0xF8000628, 0, 0); /* loc2 */
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(6,1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15654, "interface", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1693_19408 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1693_19409 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1692, Current, 2, 1, 25856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1692, Current, 25856);
	RTCC(arg1, 1692, l_feature_name, 1, RTWCT(16211, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(5);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16214, dtype))(Current, ur1x);
	RTHOOK(6);
...
void F1693_19410 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1692, Current, 1, 0, 25857);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16211, 0xF80003A1, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16211, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1693_19411 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1692, Current, 0, 1, 25858);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1692, Current, 25858);
	RTCC(arg1, 1692, l_feature_name, 1, RTWCT(16211, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16211, 0xF80003A1, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16211, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
