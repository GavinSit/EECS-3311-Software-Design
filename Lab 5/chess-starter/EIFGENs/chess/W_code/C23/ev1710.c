...
extern EIF_TYPED_VALUE F1710_19534(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1710_19535(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1710_19536(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1710_19537(EIF_REFERENCE);
extern void F1710_19545(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1710_19546(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1710_19547(EIF_REFERENCE);
extern void F1710_19548(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1710_19549(EIF_REFERENCE);
static EIF_TYPED_VALUE F1710_19555_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1710_19555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1710_19556(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1710_19557(EIF_REFERENCE);
extern void F1710_19558(EIF_REFERENCE);
extern void F1710_19560(EIF_REFERENCE);
extern void F1710_25590(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1710_19534 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 2, 0, 25946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 == NULL)) {
		...
		loc1 = RTCCL(Current);
		loc1 = RTRV(eif_new_type(1621, 0x00), loc1);
		RTHOOK(4);
...
EIF_TYPED_VALUE F1710_19535 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1710_19536 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16322,Dtype(Current)));
	return r;
}


/* {EV_WIDGET_I}.default_key_processing_handler */
EIF_TYPED_VALUE F1710_19537 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16323,Dtype(Current)));
	return r;
}


/* {EV_WIDGET_I}.set_actual_drop_target_agent */
void F1710_19545 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1709, Current, 1, 1, 25950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25950);
	RTCC(arg1, 1709, l_feature_name, 1, RTWCT(16321, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(16321, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(4,3);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15890, "pnd_targets", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,4);
	ui4_1 = loc1;
	ui4_2 = loc1;
...
void F1710_19546 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 0, 1, 25951);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25951);
	RTCC(arg1, 1709, l_feature_name, 1, eif_new_type(1579, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 16322, 0xF800062B, 0); /* real_target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16322, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("assigned", EX_POST);
...
void F1710_19547 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 0, 0, 25952);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25952);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16322, 0xF800062B, 0); /* real_target */
	*(EIF_REFERENCE *)(Current + RTWA(16322, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
void F1710_19548 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1709, Current, 0, 1, 25953);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25953);
	RTCC(arg1, 1709, l_feature_name, 1, RTWCT(16323, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1710_19549 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 0, 0, 25954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25954);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16323, 0xF8000383, 0); /* default_key_processing_handler */
	*(EIF_REFERENCE *)(Current + RTWA(16323, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
static EIF_TYPED_VALUE F1710_19555_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1709, Current, 0, 0, 25956);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25956);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1710_19555 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15654, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1710_19555_body (Current)).it_r;
...
EIF_TYPED_VALUE F1710_19556 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1709, Current, 1, 1, 25957);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25957);
	RTCC(arg1, 1709, l_feature_name, 1, eif_new_type(1771, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1710_19557 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 0, 0, 25958);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25958);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1710_19558 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 0, 0, 25959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25959);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("parent_void", EX_PRE);
...
void F1710_19560 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1709, Current, 2, 0, 25960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1709, Current, 25960);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tb1 = '\0';
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		tb2 = *(EIF_BOOLEAN *)(loc1 + RTVA(16464, "help_enabled", loc1));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	if (tb1) {
		RTHOOK(7);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(16465, "enable_help", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
...
void F1710_25590 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1709, Current, 0, 25589);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16324, dtype))(Current)).it_b);
		tb1 = tb2;
	}
	if (tb1) {
		RTCK;
