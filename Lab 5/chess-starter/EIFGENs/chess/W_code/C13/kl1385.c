...
extern EIF_TYPED_VALUE F1385_14555(EIF_REFERENCE);
...
RTOID (F1385_14555)
EIF_TYPED_VALUE F1385_14555 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1384, Current, 0, 0, 21144);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1384, Current, 21144);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
