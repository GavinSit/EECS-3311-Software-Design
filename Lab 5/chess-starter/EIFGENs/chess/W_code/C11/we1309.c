...
{
	GTCX
	char *l_feature_name = "wel_window_constants";
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 20157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 20157);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
/* {WEL_CONSTANTS}.wel_list_view_constants */
RTOID (F1309_13930)
EIF_TYPED_VALUE F1309_13930 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "wel_list_view_constants";
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	RTCDD;
	RTSN;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 20158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 20158);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	char *l_feature_name = "wel_input_constants";
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	RTCDD;
	RTSN;
...
{
	GTCX
	char *l_feature_name = "wel_drawing_constants";
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	RTCDD;
	RTSN;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 20161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	char *l_feature_name = "wel_ownerdraw_constants";
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	RTCDD;
	RTSN;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 20162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {WEL_CONSTANTS}.wel_ht_constants */
RTOID (F1309_13935)
EIF_TYPED_VALUE F1309_13935 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "wel_ht_constants";
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	RTCDD;
	RTSN;
...
{
	GTCX
	RTOTS (13929,F1309_13929)
	RTOTS (13930,F1309_13930)
	RTOTS (13931,F1309_13931)
	RTOTS (13932,F1309_13932)
	RTOTS (13933,F1309_13933)
