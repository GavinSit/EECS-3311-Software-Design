...
extern EIF_TYPED_VALUE F1314_13960(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1314_13963(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1314_13964(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1314_13960 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(11578,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1314_13964 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 11589, 0x10000000, 1); /* internal_object_id */
		ur1 = RTCCL(Current);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 11578, 0x04000000, 1); /* reference_tracked */
	*(EIF_BOOLEAN *)(Current + RTWA(11578, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(4);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11579, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 11581, 0x10000000, 1); /* references_count */
	...
	RTHOOK(7);
	RTDBGAA(Current, dtype, 11590, 0x10000000, 1); /* internal_number_id */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(11590, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(11590, dtype));
		tr3 = c_outi(ti4_1);
		ur1 = RTCCL(tr3);
		...
		if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
			...
			if (
				...
				for (;;) {
					...
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(27, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					RTNHOOK(12,1);
					tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11592, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
					RTNHOOK(12,2);
...
#define ui4_1 ui4_1x.it_i4
	...
	if ((EIF_BOOLEAN)(ti4_1 != ((EIF_INTEGER_32) 0L))) {
		...
		RTHOOK(15);
		RTDBGAA(Current, dtype, 11589, 0x10000000, 1); /* internal_object_id */
		*(EIF_INTEGER_32 *)(Current + RTWA(11589, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(16);
...
EIF_TYPED_VALUE F1314_13972 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(11590,Dtype(Current)));
	return r;
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1313, Current, 0, 0, 20199);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1313, Current, 20199);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
