...
extern EIF_TYPED_VALUE F1549_17423(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1549_17423 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1548, Current, 0, 0, 24085);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1548, Current, 24085);
	RTIV(Current, RTAL);
	RTHOOK(1);
