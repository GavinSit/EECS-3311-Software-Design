...
extern EIF_TYPED_VALUE F1631_18402(EIF_REFERENCE);
extern void F1631_18403(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1631_18402 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1631_18403 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1630, Current, 0, 0, 25246);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006D1, 0); /* implementation */
