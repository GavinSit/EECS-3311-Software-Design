...
extern EIF_TYPED_VALUE F1632_18404(EIF_REFERENCE);
extern void F1632_18405(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1632_18404 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1632_18405 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1631, Current, 0, 0, 25248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 25248);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006D2, 0); /* implementation */
