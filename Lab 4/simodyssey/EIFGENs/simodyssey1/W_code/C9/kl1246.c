...
extern EIF_TYPED_VALUE F1246_13036(EIF_REFERENCE);
...
RTOID (F1246_13036)
EIF_TYPED_VALUE F1246_13036 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1245, Current, 0, 0, 19309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1245, Current, 19309);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
