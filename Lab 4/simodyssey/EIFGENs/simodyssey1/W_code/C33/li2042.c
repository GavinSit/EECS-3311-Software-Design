...
extern void F2042_3561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2042_3562(EIF_REFERENCE);
extern void F2042_3563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2042_3564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2042_3565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2042_3566(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2042_3567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2042_3568(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F2042_3561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2041, Current, 1, 1, 20704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20704);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F2042_3562 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2041, Current, 1, 0, 20705);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20705);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F2042_3563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2041, Current, 0, 1, 20706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20706);
	RTCC(arg1, 2041, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F2042_3564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2041, Current, 0, 1, 20707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20707);
	RTCC(arg1, 2041, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F2042_3565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2041, Current, 0, 1, 20700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20700);
	RTCC(arg1, 2041, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F2042_3566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2041, Current, 0, 0, 20701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20701);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2042_3567 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2041, Current, 1, 0, 20702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20702);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2042_3568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2041, Current, 3, 1, 20703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20703);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
