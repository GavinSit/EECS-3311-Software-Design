...
void F2034_4189 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 2033, Current, 0, 0, 20839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_REFERENCE *)(Current + RTWA(3111, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 2034))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 0, 1, 20840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20840);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(3111, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3082, 2034))(Current, ui4_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 1, 2, 20843);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20843);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 1, 2, 20844);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20844);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("item_index_valid", EX_PRE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 0, 1, 20845);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20845);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
