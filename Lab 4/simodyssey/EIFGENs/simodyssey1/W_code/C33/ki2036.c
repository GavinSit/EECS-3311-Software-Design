...
extern EIF_TYPED_VALUE F2036_12757(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2036_12758(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2036_12760(EIF_REFERENCE);
extern void F2036_12765(EIF_REFERENCE);
extern void F2036_12766(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2036_12757 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2035, Current, 2, 3, 19049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2035, Current, 19049);
	{
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			ur1 = RTCCL(tr1);
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(9450, "put", arg1))(arg1, ur1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F2036_12758 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2035, Current, 0, 0, 19050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2035, Current, 19050);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2036_12760 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2035, Current, 0, 0, 19051);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2035, Current, 19051);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F2036_12765 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2035, Current, 0, 0, 19052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2035, Current, 19052);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2036_12766 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2035, Current, 0, 0, 19053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2035, Current, 19053);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
