...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,998,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1020 [] = {0xFF01,998,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1020 [] = {0xFF01,998,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1020 [] = {0xFF01,998,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_GENERIC(egt_13_1020), 15977, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1020), 15970, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1020), 15971, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1020), 15972, 0xFFFFFFFF},
};
void Init1020(void)
{
	IDSC(desc_1020, 0, 1019);
	IDSC(desc_1020 + 1, 1, 1019);
	IDSC(desc_1020 + 32, 781, 1019);
}
