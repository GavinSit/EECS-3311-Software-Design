...
extern void F1003_9191(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1003_9191 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 1, 15494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 1002, l_feature_name, 1, eif_new_type(1835, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6977, 0xF800072B, 0); /* message_information */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
