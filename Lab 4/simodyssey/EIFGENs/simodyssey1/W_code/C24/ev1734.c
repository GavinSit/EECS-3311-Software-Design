...
extern EIF_TYPED_VALUE F1734_19700(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1734_19700 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1733, Current, 0, 0, 26317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1733, Current, 26317);
	RTIV(Current, RTAL);
	RTHOOK(1);
