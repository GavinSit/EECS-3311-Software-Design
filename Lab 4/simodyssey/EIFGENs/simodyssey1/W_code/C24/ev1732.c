...
extern EIF_TYPED_VALUE F1732_19688(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1732_19689(EIF_REFERENCE);
extern void F1732_19690(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1732_19691(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1732_19692(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1732_19688 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1731, Current, 1, 0, 26311);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1731, Current, 26311);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1732_19689 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1731, Current, 1, 0, 26312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1731, Current, 26312);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16470, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
...
void F1732_19690 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1731, Current, 0, 1, 26313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1731, Current, 26313);
	RTCC(arg1, 1731, l_feature_name, 1, eif_new_type(1646, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1732_19691 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1731, Current, 0, 0, 26314);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1731, Current, 26314);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16470, 0xF800066E, 0); /* private_pixmap */
...
EIF_TYPED_VALUE F1732_19692 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
