...
extern EIF_TYPED_VALUE F1724_19662(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1724_19663(EIF_REFERENCE);
extern void F1724_19664(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1724_19665(EIF_REFERENCE);
extern void F1724_19666(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1723, Current, 2, 0, 26292);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1723, Current, 26292);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16445, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1724_19662 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1723, Current, 3, 0, 26293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1723, Current, 26293);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16449, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc3 = RTCCL(tr1);
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16445, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
				RTDBGAL(2, 0xF8000647, 0, 0); /* loc2 */
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(6,1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15892, "interface", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1724_19663 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1723, Current, 2, 1, 26295);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1723, Current, 26295);
	RTCC(arg1, 1723, l_feature_name, 1, RTWCT(16449, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16451, dtype))(Current);
	}
	RTHOOK(5);
	ur1 = RTCCL(arg1);
...
void F1724_19665 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1723, Current, 1, 0, 26296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1723, Current, 26296);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16449, 0xF80003A1, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16449, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1724_19666 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1723, Current, 0, 1, 26297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1723, Current, 26297);
	RTCC(arg1, 1723, l_feature_name, 1, RTWCT(16449, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16449, 0xF80003A1, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16449, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
