...
extern EIF_TYPED_VALUE F1666_18804(EIF_REFERENCE);
extern void F1666_18805(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1666_18804 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1666_18805 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1665, Current, 0, 0, 25649);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1665, Current, 25649);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006F4, 0); /* implementation */
