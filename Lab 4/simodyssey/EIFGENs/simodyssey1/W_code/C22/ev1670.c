...
extern EIF_TYPED_VALUE F1670_18821(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1670_18822(EIF_REFERENCE);
extern void F1670_18823(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1670_18821 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1669, Current, 0, 0, 25665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1669, Current, 25665);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1670_18823 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF8000700, 0); /* implementation */
