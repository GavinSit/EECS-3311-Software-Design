...
extern EIF_TYPED_VALUE F1657_18763(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1657_18764(EIF_REFERENCE);
extern void F1657_18765(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1657_18763 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1656, Current, 0, 0, 25609);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1656, Current, 25609);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15019, 1650))(Current)).it_b);
	if (tb2) {
...
EIF_TYPED_VALUE F1657_18764 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1657_18765 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1656, Current, 0, 0, 25611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1656, Current, 25611);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006ED, 0); /* implementation */
