...
extern EIF_TYPED_VALUE F1668_18816(EIF_REFERENCE);
extern void F1668_18817(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1668_18816 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1668_18817 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1667, Current, 0, 0, 25660);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1667, Current, 25660);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006FE, 0); /* implementation */
