...
extern EIF_TYPED_VALUE F1673_18835(EIF_REFERENCE);
extern void F1673_18836(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1673_18835 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1673_18836 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1672, Current, 0, 0, 25680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1672, Current, 25680);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006F9, 0); /* implementation */
