...
extern EIF_TYPED_VALUE F1661_18780(EIF_REFERENCE);
extern void F1661_18781(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1661_18780 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1661_18781 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1660, Current, 0, 0, 25627);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1660, Current, 25627);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15014, 0xF80006F1, 0); /* implementation */
