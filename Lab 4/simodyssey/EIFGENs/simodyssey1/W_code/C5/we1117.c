...
extern EIF_TYPED_VALUE F1117_10769(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1117_10770(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1117_10771(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1117_10769 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1116, Current, 0, 0, 17136);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1116, Current, 17136);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1117_10770 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1116, Current, 0, 0, 17137);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1116, Current, 17137);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1117_10771 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1116, Current, 0, 1, 17138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1116, Current, 17138);
	RTIV(Current, RTAL);
	RTHOOK(1);
