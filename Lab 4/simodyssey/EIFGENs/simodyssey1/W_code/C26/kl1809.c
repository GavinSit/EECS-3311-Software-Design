...
extern EIF_TYPED_VALUE F1809_20470(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1809_20470 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1808, Current, 0, 0, 26755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1808, Current, 26755);
	RTIV(Current, RTAL);
	RTHOOK(1);
