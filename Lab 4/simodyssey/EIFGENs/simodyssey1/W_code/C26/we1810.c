...
extern EIF_TYPED_VALUE F1810_20471(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1810_20472(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1810_20473(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1810_20471 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1809, Current, 0, 1, 26756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1809, Current, 26756);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1810_20472 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1809, Current, 0, 0, 26757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1809, Current, 26757);
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		ui4_1 = Result;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(17132, dtype))(Current, ui4_1x)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1810_20473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1809, Current, 1, 1, 26758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(RTWCT(17134, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
