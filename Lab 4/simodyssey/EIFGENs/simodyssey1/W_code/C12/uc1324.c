...
extern EIF_TYPED_VALUE F1324_14065(EIF_REFERENCE);
...
RTOID (F1324_14065)
EIF_TYPED_VALUE F1324_14065 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1323, Current, 0, 0, 20319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
