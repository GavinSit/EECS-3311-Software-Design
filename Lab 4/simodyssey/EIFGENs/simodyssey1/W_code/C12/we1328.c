...
extern EIF_TYPED_VALUE F1328_14136(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1328_14136 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1327, Current, 0, 1, 20388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1327, Current, 20388);
	RTIV(Current, RTAL);
	RTHOOK(1);
