...
extern EIF_TYPED_VALUE F1416_14810(EIF_REFERENCE);
...
RTOID (F1416_14810)
EIF_TYPED_VALUE F1416_14810 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1415, Current, 0, 0, 21433);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 21433);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
