...
extern void F1515_16568(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1515_16569(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1515_16570(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1515_16571(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1515_16572(EIF_REFERENCE);
extern void F1515_25796(EIF_REFERENCE, int);
...
void F1515_16568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1514, Current, 4, 1, 23206);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1514, Current, 23206);
	{
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 13900, 0x10000000, 1); /* count */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2269, "count", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(13900, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	...
	for (;;) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13901, dtype))(Current)).it_i4);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(2664, "lower", arg1));
		ui4_1 = ti4_1;
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13899, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1515_16569 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1514, Current, 4, 1, 23207);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1514, Current, 23207);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
	...
	RTHOOK(2);
	RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(13900, dtype));
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(13900, dtype));
...
EIF_TYPED_VALUE F1515_16570 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(13900,Dtype(Current)));
	return r;
}


/* {WEL_INTEGER_ARRAY}.structure_size */
EIF_TYPED_VALUE F1515_16571 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1514, Current, 0, 0, 23209);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1514, Current, 23209);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1515_16572 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F1515_25796 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1514, Current, 0, 25795);
	RTSA(dtype);
	RTME(dtype, 0);
