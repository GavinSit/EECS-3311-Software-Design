...
extern void F1516_16573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1516_16574(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1516_16575(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1516_16576(EIF_REFERENCE);
extern void F1516_25797(EIF_REFERENCE, int);
...
void F1516_16573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1515, Current, 1, 1, 23212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1515, Current, 23212);
	{
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 13904, 0x10000000, 1); /* count */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(13904, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (RTAL & CK_ENSURE) {
		...
		ui4_1 = ti4_1;
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13903, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1516_16574 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1515, Current, 2, 1, 23213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1515, Current, 23213);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1516_16575 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1516_16576 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1515, Current, 0, 0, 23215);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1515, Current, 23215);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1516_25797 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1515, Current, 0, 25796);
	RTSA(dtype);
	RTME(dtype, 0);
