...
extern EIF_TYPED_VALUE F1923_23302(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1923_23303(EIF_REFERENCE);
extern void F1923_23304(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1923_23305(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1923_23306(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1923_23307(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1923_23302 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1922, Current, 0, 0, 29445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29445);
	RTIV(Current, RTAL);
...
body:;
	...
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19350, dtype))(Current)).it_p);
	up1 = tp1;
...
EIF_TYPED_VALUE F1923_23303 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 3, 0, 29446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29446);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1923_23304 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 1, 1, 29447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29447);
	if (arg1) {
		RTCC(arg1, 1922, l_feature_name, 1, eif_new_type(229, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1923_23305 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 0, 1, 29448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29448);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
EIF_TYPED_VALUE F1923_23306 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 0, 0, 29449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29449);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
RTOID (F1923_23307)
EIF_TYPED_VALUE F1923_23307 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1923_23307);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1922, Current, 0, 0, 29450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 29450);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	...
	ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9855, dtype))(Current)).it_i4);
