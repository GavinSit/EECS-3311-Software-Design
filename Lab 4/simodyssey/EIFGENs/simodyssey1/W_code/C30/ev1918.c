...
extern EIF_TYPED_VALUE F1918_23155(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1918_23156(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1918_23155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1917, Current, 0, 0, 29298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1917, Current, 29298);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1918_23156 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1917, Current, 0, 0, 29299);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1917, Current, 29299);
	RTIV(Current, RTAL);
	RTHOOK(1);
