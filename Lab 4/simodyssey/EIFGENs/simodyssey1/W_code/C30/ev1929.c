...
extern EIF_TYPED_VALUE F1929_23340(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1929_23341(EIF_REFERENCE);
extern void F1929_23342(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1929_23343(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1929_23344(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1929_23340 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1928, Current, 1, 0, 29485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1928, Current, 29485);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1929_23341 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1928, Current, 1, 0, 29486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1928, Current, 29486);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1929_23342 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1928, Current, 0, 1, 29487);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1928, Current, 29487);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 19370, 0xF80000EE, 0); /* internal_text */
		*(EIF_REFERENCE *)(Current + RTWA(19370, dtype)) = (EIF_REFERENCE) NULL;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1929_23343 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
RTOID (F1929_23344)
EIF_TYPED_VALUE F1929_23344 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1929_23344);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1928, Current, 0, 0, 29484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1928, Current, 29484);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18790, 1927))(Current)).it_i4);
