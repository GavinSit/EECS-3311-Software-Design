...
extern void F1925_23314(EIF_REFERENCE);
extern void F1925_23315(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1925_23316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1925_23317(EIF_REFERENCE);
...
void F1925_23314 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1924, Current, 0, 0, 29457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1924, Current, 29457);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19355, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1925_23315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1924, Current, 0, 0, 29458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1924, Current, 29458);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
EIF_TYPED_VALUE F1925_23316 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1924, Current, 0, 0, 29459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1924, Current, 29459);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
RTOID (F1925_23317)
EIF_TYPED_VALUE F1925_23317 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1925_23317);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1924, Current, 0, 0, 29460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1924, Current, 29460);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11022, dtype))(Current)).it_i4);
