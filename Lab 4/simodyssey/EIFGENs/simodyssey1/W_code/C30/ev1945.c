...
extern void F1945_23899(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1945_23900_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1945_23900(EIF_REFERENCE);
...
void F1945_23899 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1944, Current, 0, 1, 30032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1944, Current, 30032);
...
static EIF_TYPED_VALUE F1945_23900_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1944, Current, 0, 0, 30033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1944, Current, 30033);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1945_23900 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15892, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1945_23900_body (Current)).it_r;
