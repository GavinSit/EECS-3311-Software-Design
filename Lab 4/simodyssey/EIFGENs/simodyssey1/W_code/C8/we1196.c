...
extern EIF_TYPED_VALUE F1196_12088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1196_12089(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1196_12088 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1195, Current, 0, 0, 18411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 18411);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000768, 0,0); /* Result */
...
RTOID (F1196_12089)
EIF_TYPED_VALUE F1196_12089 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1195, Current, 0, 0, 18412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 18412);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,1896,0xFFFF};
		EIF_TYPE typres0;
