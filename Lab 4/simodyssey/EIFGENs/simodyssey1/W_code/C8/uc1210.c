...
extern EIF_TYPED_VALUE F1210_12302(EIF_REFERENCE);
...
RTOID (F1210_12302)
EIF_TYPED_VALUE F1210_12302 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1209, Current, 0, 0, 18609);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1209, Current, 18609);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
