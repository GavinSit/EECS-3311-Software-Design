...
extern EIF_TYPED_VALUE F1209_12301(EIF_REFERENCE);
...
RTOID (F1209_12301)
EIF_TYPED_VALUE F1209_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1208, Current, 0, 0, 18608);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1208, Current, 18608);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
