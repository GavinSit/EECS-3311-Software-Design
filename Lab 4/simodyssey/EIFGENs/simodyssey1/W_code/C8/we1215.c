...
extern EIF_TYPED_VALUE F1215_12407(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1215_12408(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1215_12409(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1215_12407 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1214, Current, 0, 0, 18713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1214, Current, 18713);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1215_12408 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
RTOID (F1215_12409)
EIF_TYPED_VALUE F1215_12409 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1214, Current, 0, 0, 18715);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1214, Current, 18715);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,0xFF01,1900,0xFFFF};
		EIF_TYPE typres0;
	...
	tr2 = RTLN(eif_new_type(1900, 0x01).id);
	tr3 = RTMS_EX_H("WEL Silly Window",16,787402615);
	ur1 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(18976, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
