...
extern void F1950_23974(EIF_REFERENCE);
extern void F1950_23975(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1950_23976(EIF_REFERENCE);
static EIF_TYPED_VALUE F1950_23977_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1950_23977(EIF_REFERENCE);
extern void F1950_23978(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1950_23974 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1949, Current, 1, 0, 30099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1949, Current, 30099);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 19638, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19638, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(19638, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1950_23975 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1949, Current, 1, 0, 30100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1949, Current, 30100);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
EIF_TYPED_VALUE F1950_23976 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1950_23977_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1949, Current, 0, 0, 30102);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1949, Current, 30102);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1950_23977 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15892, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1950_23977_body (Current)).it_r;
...
void F1950_23978 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1949, Current, 0, 1, 30103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19638, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19638, dtype)) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
