...
extern void F1962_24382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1962_24383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_24384(EIF_REFERENCE);
extern void F1962_24385(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1962_24386(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1962_24387(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1962_24388(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1962_24389(EIF_REFERENCE);
extern void F1962_24390(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1962_24391_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_24391(EIF_REFERENCE);
...
void F1962_24382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1961, Current, 0, 1, 30447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30447);
	RTCC(arg1, 1961, l_feature_name, 1, RTWCT(15892, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1962_24383 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1961, Current, 0, 0, 30448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30448);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1962_24384 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1962_24385 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1961, Current, 1, 1, 30450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30450);
	if (arg1) {
		RTCC(arg1, 1961, l_feature_name, 1, eif_new_type(1964, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1962_24386 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1961, Current, 2, 1, 30451);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30451);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1962_24387 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1961, Current, 2, 1, 30452);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30452);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
void F1962_24388 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1961, Current, 3, 1, 30453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30453);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1962_24389 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1961, Current, 0, 0, 30454);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30454);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1962_24390 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1961, Current, 0, 2, 30455);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30455);
	RTCC(arg1, 1961, l_feature_name, 1, eif_new_type(1451, 0x01), 0x01);
	RTCC(arg2, 1961, l_feature_name, 2, eif_new_type(1545, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1962_24391_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1961, Current, 0, 0, 30456);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 30456);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1962_24391 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15892, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1962_24391_body (Current)).it_r;
