...
extern EIF_TYPED_VALUE F1376_14541(EIF_REFERENCE);
...
RTOID (F1376_14541)
EIF_TYPED_VALUE F1376_14541 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1375, Current, 0, 0, 21125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1375, Current, 21125);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
