...
extern void F1052_25764(EIF_REFERENCE, int);
...
void F1052_25764 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1051, Current, 0, 25763);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
