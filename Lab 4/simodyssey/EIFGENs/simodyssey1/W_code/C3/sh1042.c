...
extern void F1042_25761(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1041, Current, 0, 0, 16341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1041, Current, 16341);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1042_25761 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1041, Current, 0, 25760);
	RTSA(dtype);
	RTME(dtype, 0);
