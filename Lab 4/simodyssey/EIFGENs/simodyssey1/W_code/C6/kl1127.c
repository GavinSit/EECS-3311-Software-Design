...
extern EIF_TYPED_VALUE F1127_10839(EIF_REFERENCE);
...
RTOID (F1127_10839)
EIF_TYPED_VALUE F1127_10839 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 17188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1126, Current, 17188);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
