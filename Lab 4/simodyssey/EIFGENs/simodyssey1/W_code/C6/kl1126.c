...
extern EIF_TYPED_VALUE F1126_10838(EIF_REFERENCE);
...
RTOID (F1126_10838)
EIF_TYPED_VALUE F1126_10838 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1125, Current, 0, 0, 17187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1125, Current, 17187);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
