...
extern void F1988_25171(EIF_REFERENCE);
extern void F1988_25172(EIF_REFERENCE);
extern void F1988_25173(EIF_REFERENCE);
extern void F1988_25174(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1988_25175(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1988_25176(EIF_REFERENCE);
extern void F1988_25177(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1988_25178_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1988_25178(EIF_REFERENCE);
...
void F1988_25171 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31229);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15887, 1986))(Current);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 20062, 0x10000000, 1); /* extra_width */
	*(EIF_INTEGER_32 *)(Current + RTWA(20062, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 20L);
	RTHOOK(3);
...
void F1988_25172 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1987, Current, 2, 0, 31222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31222);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19680, 1986))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
...
void F1988_25173 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31223);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16460, 1986))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F1988_25174 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31224);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7536, 1024))(Current, up1x, ui4_1x, up2x, up3x);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16462, 1986))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1988_25175 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31225);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1988_25176 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31226);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
void F1988_25177 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1987, Current, 0, 1, 31227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31227);
	RTCC(arg1, 1987, l_feature_name, 1, eif_new_type(1597, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1988_25178_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1987, Current, 0, 0, 31228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1987, Current, 31228);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1988_25178 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15892, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1988_25178_body (Current)).it_r;
