...
extern EIF_TYPED_VALUE F2068_12757(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2068_12758(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2068_12760(EIF_REFERENCE);
extern void F2068_12765(EIF_REFERENCE);
extern void F2068_12766(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2068_12757 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 2067, Current, 2, 3, 19054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2067, Current, 19054);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,2068,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(10531, dtype, Dftype(Current));
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(12);
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10528, dtype))(Current)).it_c1);
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(9450, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F2068_12758 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2067, Current, 0, 0, 19055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2067, Current, 19055);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2068_12760 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2067, Current, 0, 0, 19056);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2067, Current, 19056);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F2068_12765 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2067, Current, 0, 0, 19057);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2067, Current, 19057);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2068_12766 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2067, Current, 0, 0, 19058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2067, Current, 19058);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
