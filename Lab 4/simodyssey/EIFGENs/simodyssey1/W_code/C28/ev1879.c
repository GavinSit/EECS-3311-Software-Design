...
extern EIF_TYPED_VALUE F1879_22120(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1879_22121(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1879_22122(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1879_22123(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1879_22120 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1878, Current, 1, 0, 28285);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1878, Current, 28285);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1879_22121 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1878, Current, 1, 0, 28286);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1878, Current, 28286);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF8000713, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1811, 0x01).id);
...
EIF_TYPED_VALUE F1879_22122 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1878, Current, 1, 0, 28287);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1878, Current, 28287);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF8000713, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1811, 0x01).id);
...
EIF_TYPED_VALUE F1879_22123 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1878, Current, 1, 0, 28288);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1878, Current, 28288);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF8000713, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1811, 0x01).id);
