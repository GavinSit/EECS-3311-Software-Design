...
extern EIF_TYPED_VALUE F1852_21226(EIF_REFERENCE);
...
RTOID (F1852_21226)
EIF_TYPED_VALUE F1852_21226 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1852_21226);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1851, Current, 0, 0, 27404);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1851, Current, 27404);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
