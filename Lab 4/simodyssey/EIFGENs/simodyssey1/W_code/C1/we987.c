...
extern EIF_TYPED_VALUE F987_8993(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F987_9001(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F987_8993 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F987_9001 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 986, Current, 0, 1, 15304);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 15304);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case -1L:
	...
	if (RTAL & CK_ENSURE) {
		...
		*((EIF_INTEGER_32 *)tr2+1) = (EIF_INTEGER_32) ti4_1;
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6785, dtype))(Current)).it_i4);
		*((EIF_INTEGER_32 *)tr2+2) = (EIF_INTEGER_32) ti4_1;
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6786, dtype))(Current)).it_i4);
		...
		*((EIF_INTEGER_32 *)tr2+5) = (EIF_INTEGER_32) ti4_1;
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6790, dtype))(Current)).it_i4);
