...
static const EIF_TYPE_INDEX egt_13_970 [] = {0xFF01,270,0xFF01,960,0xFFFF};
static const EIF_TYPE_INDEX egt_14_970 [] = {0xFF01,171,0xFFFF};
...
static const struct desc_info desc_970[] = {
	...
	{EIF_GENERIC(egt_14_970), 15159, 0xFFFFFFFF},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
	IDSC(desc_970 + 1, 1, 969);
	IDSC(desc_970 + 32, 1282, 969);
}
