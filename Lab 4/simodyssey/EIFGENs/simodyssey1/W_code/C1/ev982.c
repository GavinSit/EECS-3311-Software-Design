...
extern void F982_8945(EIF_REFERENCE);
extern void F982_8946(EIF_REFERENCE);
extern void F982_8947(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F982_8953(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8954(EIF_REFERENCE);
extern void F982_25756(EIF_REFERENCE, int);
...
void F982_8942 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6735, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F982_8945 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6741, 0x10000000, 1); /* alignment_code */
...
void F982_8946 (EIF_REFERENCE Current)
{
	GTCX
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6741, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6739, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F982_8947 (EIF_REFERENCE Current)
{
	GTCX
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6741, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6740, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F982_8948 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 15250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 15250);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6741, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6742, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F982_8949 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 15251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F982_8950 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 15252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F982_8953 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F982_8954 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F982_25756 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 981, Current, 0, 25755);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6744, dtype))(Current)).it_i4);
