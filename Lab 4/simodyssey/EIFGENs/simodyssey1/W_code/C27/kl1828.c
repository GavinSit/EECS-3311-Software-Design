...
extern void F1828_20887(EIF_REFERENCE);
extern void F1828_20888(EIF_REFERENCE);
extern void F1828_20889(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F1828_20886,27112,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1828_20887 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1827, Current, 5, 0, 27112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(17438, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1828_20888 (EIF_REFERENCE Current)
{
	GTCX
...
void F1828_20889 (EIF_REFERENCE Current)
{
	GTCX
