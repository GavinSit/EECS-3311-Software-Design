...
extern EIF_TYPED_VALUE F1841_21008(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1841_21008 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1840, Current, 0, 0, 27233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1840, Current, 27233);
	RTIV(Current, RTAL);
	RTHOOK(1);
