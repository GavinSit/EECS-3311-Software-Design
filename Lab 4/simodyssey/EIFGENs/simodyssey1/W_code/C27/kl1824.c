...
extern void F1824_20858(EIF_REFERENCE);
extern void F1824_20859(EIF_REFERENCE);
...
void F1824_20858 (EIF_REFERENCE Current)
{
	GTCX
...
void F1824_20859 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17427, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
