...
extern EIF_TYPED_VALUE F1843_21026(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1843_21026 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1842, Current, 0, 0, 27251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1842, Current, 27251);
	RTIV(Current, RTAL);
	RTHOOK(1);
