...
extern EIF_TYPED_VALUE F1840_21006(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1840_21007(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1840_21006 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1839, Current, 0, 0, 27231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1839, Current, 27231);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1840_21007 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1839, Current, 0, 0, 27232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1839, Current, 27232);
	RTIV(Current, RTAL);
	RTHOOK(1);
