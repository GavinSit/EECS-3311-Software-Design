...
extern EIF_TYPED_VALUE F1829_20890(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1829_20891(EIF_REFERENCE);
extern void F1829_20892(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1829_20890 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1829_20891 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1829_20892 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1828, Current, 0, 0, 27117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1828, Current, 27117);
	RTIV(Current, RTAL);
