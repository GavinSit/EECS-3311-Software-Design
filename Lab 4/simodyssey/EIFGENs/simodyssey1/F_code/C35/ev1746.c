...
EIF_INTEGER_32 F1757_19872 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = F1169_14637(RTCW(tr1));
	ti4_1 = F1970_24045(Current);
...
EIF_INTEGER_32 F1757_19873 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	Result = F1614_18069(RTCW(tr1));
	RTLE;
	return Result;
}

/* {EV_VERTICAL_BOX_I}.docking_dimension_of_current */
EIF_INTEGER_32 F1757_19874 (EIF_REFERENCE Current)
{
	GTCX
	
	
	return (EIF_INTEGER_32) F1970_24043(Current);
}
