...
static EIF_REFERENCE F206_10849_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F206_10849 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(214,F206_10849_body,(Current));
}

/* {DATE_TIME_TOOLS}.months_text */
static EIF_REFERENCE F206_10850_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
EIF_REFERENCE F206_10850 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(215,F206_10850_body,(Current));
}

/* {DATE_TIME_TOOLS}.date_default_format_string */

EIF_REFERENCE F206_10853 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F206_10854 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (217,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}

/* {DATE_TIME_TOOLS}.default_format_string */

EIF_REFERENCE F206_10855 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (243,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
