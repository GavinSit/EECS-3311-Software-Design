...
/* {LIST}.is_equal */
EIF_BOOLEAN F887_3331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F743_2537(RTCW(arg1));
		if ((EIF_BOOLEAN)(F743_2537(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F956_4094(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F743_2537(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F956_4084(Current);
			loc1 = tr1;
			if ((EIF_TRUE)) {
				tr1 = F956_4084(RTCW(arg1));
				loc2 = tr1;
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O2212[dtype-574])) {
						tc1 = F956_4078(Current);
						tc2 = F956_4078(RTCW(arg1));
				...
				F956_4109(RTCW(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F743_2537(Current)) {
				tb4 = F743_2537(RTCW(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F887_3332 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F887_3333 (EIF_REFERENCE Current)
{
	GTCX
