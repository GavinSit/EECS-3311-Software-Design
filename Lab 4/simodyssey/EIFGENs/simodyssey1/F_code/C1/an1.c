...
void F1_23 (EIF_REFERENCE Current)
{
	...
	RTGC;
	loc3 = RTCCL(Current);
	loc3 = RTRV(eif_new_type(947, 0x01),loc3);
	if (EIF_TEST(loc3)) {
		(FUNCTION_CAST(void, (EIF_REFERENCE)) R2934[Dtype(loc3)-947])(loc3);
	} else {
		...
		tr1 = F1_5(Current);
		tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3875[Dtype(RTCW(tr1))-1422])(tr1);
...
#define Result RTOTRR
	...
	RTGC;
	RTOTP;
	tr1 = RTLNS(eif_new_type(124, 0x01).id, 124, _OBJSIZ_1_0_0_0_0_0_0_0_);
	Result = (EIF_REFERENCE) tr1;
	F125_142(RTCW(Result));
	RTOTE;
	RTLE;
	RTEE;
	return Result;
