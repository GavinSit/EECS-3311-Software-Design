...
EIF_INTEGER_32 F1079_4352 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_INTEGER_32) F1056_4324(Current);
	} else {
...
EIF_BOOLEAN F1079_4353 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F1071_4342(Current);
	} else {
		Result = '\01';
...
void F1079_4354 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
...
void F1079_4355 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F1079_4356 (EIF_REFERENCE Current)
{
