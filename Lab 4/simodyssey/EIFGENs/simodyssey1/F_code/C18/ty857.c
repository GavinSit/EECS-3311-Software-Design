...
EIF_NATURAL_64 F1062_4324 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = (eif_optimize_return = 1, *(EIF_NATURAL_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2556[Dtype(RTCW(tr1))-849])(tr1, ti4_1));
	RTLE;
	return Result;
}
