...
/* {LIST}.is_equal */
EIF_BOOLEAN F890_3331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F746_2537(RTCW(arg1));
		if ((EIF_BOOLEAN)(F746_2537(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F959_4094(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
		...
		if (tb1) {
			tb1 = '\0';
			tr1 = F959_4084(Current);
			loc1 = tr1;
			if ((EIF_TRUE)) {
				tr1 = F959_4084(RTCW(arg1));
				loc2 = tr1;
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
...
/* {LIST}.after */
EIF_BOOLEAN F890_3332 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F890_3333 (EIF_REFERENCE Current)
{
	GTCX
