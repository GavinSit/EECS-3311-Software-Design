...
void F1976_24320 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTLD;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_64_19_) = (EIF_BOOLEAN) arg1;
	F1725_19528(Current, ((EIF_INTEGER_32) 1L), Current, (EIF_BOOLEAN) 0);
	RTLE;
}

/* {EV_HORIZONTAL_BOX_IMP}.set_padding */
void F1976_24321 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTLD;
...
void F1976_24322 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTLD;
...
void F1976_24323 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	GTCX
	...
	RTGC;
	ti4_1 = F1974_24282(Current);
	ti4_2 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
	F1976_24325(Current, (EIF_INTEGER_32) (ti4_1 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), (EIF_BOOLEAN) 1);
	F1970_24130(Current, arg1, arg2, arg3);
	RTLE;
}

/* {EV_HORIZONTAL_BOX_IMP}.ev_apply_new_size */
void F1976_24324 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4, EIF_BOOLEAN arg5)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_INTEGER_32 ti4_2;
	...
	ti4_1 = F1974_24282(Current);
	ti4_2 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
	F1976_24325(Current, (EIF_INTEGER_32) (ti4_1 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), (EIF_BOOLEAN) 0);
	RTLE;
}

/* {EV_HORIZONTAL_BOX_IMP}.set_children_width */
void F1976_24325 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_BOOLEAN arg2)
{
	GTCX
			...
			for (;;) {
				...
				if (tb2) {
					...
					if ((EIF_BOOLEAN)(loc16 != NULL)) {
						...
						ti4_1 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R16403[Dtype(RTCW(loc3))-1730])(loc3);
						...
						
						{
							...
							typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
							tr2= RTLNRF(typres0.id, (EIF_POINTER) __A1959_1824, (EIF_POINTER) _A1959_1824, (EIF_POINTER)(F1974_24306),tr1, 1, 0);
						}
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2222[Dtype(RTCW(loc16))-818])(loc16, tr2);
					} else {
						ti4_1 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R16403[Dtype(RTCW(loc3))-1730])(loc3);
						ti4_1 = eif_max_int32 (ti4_1,loc9);
						F1974_24306(Current, loc3, loc6, loc10, loc8, ti4_1, arg2);
					}
			...
			for (;;) {
				...
				if (tb3) {
					...
					if ((EIF_BOOLEAN)(ti4_1 != loc15)) {
						loc8 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R16402[Dtype(RTCW(loc3))-1730])(loc3);
...
void F1976_24326 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_8_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	F1725_19526(Current, (EIF_INTEGER_32) (loc4 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_))), arg1);
	RTLE;
}

/* {EV_HORIZONTAL_BOX_IMP}.compute_minimum_width */
void F1976_24327 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (*(EIF_BOOLEAN *)(Current+ _CHROFF_64_19_)) {
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_8_) = (EIF_INTEGER_32) loc5;
			...
			ti4_2 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
			F1725_19525(Current, (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (loc4 * loc5) + ti4_1) + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), arg1);
		} else {
			F951_4104(RTCW(loc1));
			for (;;) {
				tb2 = F882_3332(RTCW(loc1));
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_8_) = (EIF_INTEGER_32) loc5;
			...
			ti4_1 = F1974_24287(Current);
			ti4_2 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
			F1725_19525(Current, (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc4 + ti4_1) + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), arg1);
		}
		...
		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_12_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		F1725_19525(Current, (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_)), arg1);
	}
	RTLE;
}

/* {EV_HORIZONTAL_BOX_IMP}.compute_minimum_size */
void F1976_24328 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (*(EIF_BOOLEAN *)(Current+ _CHROFF_64_19_)) {
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_8_) = (EIF_INTEGER_32) loc6;
			...
			F1725_19527(Current, (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (loc5 * loc6) + ti4_1) + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), (EIF_INTEGER_32) (loc4 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_3)), arg1);
		} else {
			F951_4104(RTCW(loc1));
			for (;;) {
				tb2 = F882_3332(RTCW(loc1));
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_12_) = (EIF_INTEGER_32) loc5;
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_8_) = (EIF_INTEGER_32) loc6;
			F1974_24289(Current);
			ti4_1 = F1974_24287(Current);
			ti4_2 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
			ti4_3 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_64_26_6_10_);
			F1725_19527(Current, (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc5 + ti4_1) + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_2)), (EIF_INTEGER_32) (loc4 + (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * ti4_3)), arg1);
		}
		tb3 = F951_4099(RTCW(loc1), loc3);
		if (tb3) {
			F951_4109(RTCW(loc1), loc3);
