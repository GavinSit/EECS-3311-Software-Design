...
EIF_INTEGER_32 F461_1531 (EIF_REFERENCE Current)
{
	GTCX
...
/* {CHECK_VIOLATION}.tag */
static EIF_REFERENCE F461_1532_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F461_1532 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(25,F461_1532_body,(Current));
}
