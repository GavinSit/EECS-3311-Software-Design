...
static const struct desc_info desc_1023[] = {
	...
	{EIF_GENERIC(egt_16_1023), 14198, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_1023), 14199, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_1023), 14200, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 14201, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0179 /*188*/), 14202, 0xFFFFFFFF},
...
void Init1023(void)
{
	...
	IDSC(desc_1023 + 32, 397, 1022);
	IDSC(desc_1023 + 33, 386, 1022);
	IDSC(desc_1023 + 34, 408, 1022);
	IDSC(desc_1023 + 35, 419, 1022);
}
