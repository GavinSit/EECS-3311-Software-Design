...
extern EIF_TYPED_VALUE F1075_8335(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1075_8336(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1075_8335 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui1_2 ui1_2x.it_i1
	...
	RTEAA(l_feature_name, 1074, Current, 0, 2, 14569);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ui1_1 = arg1;
	ui1_2 = arg2;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5978, dtype))(Current, ui1_1x, ui1_2x)).it_b);
...
EIF_TYPED_VALUE F1075_8336 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_i1
	...
	RTEAA(l_feature_name, 1074, Current, 4, 2, 14570);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1074, Current, 14570);
	RTIV(Current, RTAL);
	RTHOOK(1);
