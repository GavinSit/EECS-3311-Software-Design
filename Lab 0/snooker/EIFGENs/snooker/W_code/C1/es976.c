...
extern void F976_7418(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F976_7419(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F976_7420(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F976_7421(EIF_REFERENCE);
extern EIF_TYPED_VALUE F976_7422(EIF_REFERENCE);
extern EIF_TYPED_VALUE F976_7423(EIF_REFERENCE);
extern void F976_7424(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F976_7425(EIF_REFERENCE);
extern void F976_7426(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {ES_SUITE}.add_test */
void F976_7418 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	if ((EIF_BOOLEAN) !(EIF_BOOLEAN)(loc1 != NULL)) {
		RTHOOK(4);
		RTDBGAL(1, 0xF80003A1, 0, 0); /* loc1 */
		tr1 = RTLNSMART(RTWCT(5206, dtype, Dftype(Current)).id);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(2763, Dtype(tr1)))(tr1);
		RTNHOOK(4,1);
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5206, 0xF80003A1, 0); /* classes */
		tr1 = RTCCL(loc1);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5206, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5205, 0xF80000E8, 0); /* name */
		...
		tr1 = RTCCL(tr2);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5205, dtype)) = (EIF_REFERENCE) tr1;
	}
	RTHOOK(7);
	ur1 = RTCCL(arg1);
...
/* {ES_SUITE}.add_suite */
void F976_7419 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5206, "classes", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
...
/* {ES_SUITE}.to_html */
void F976_7420 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	...
	ub1 = tb1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5153, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x, ub1x);
	RTNHOOK(4,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
void F976_7421 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (EIF_TEST(loc1)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(5172, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		...
		for (;;) {
			...
			RTHOOK(7);
			tb2 = *(EIF_BOOLEAN *)(Current + RTWA(5173, dtype));
			if (tb2) {
				RTHOOK(8);
				tb2 = *(EIF_BOOLEAN *)(Current + RTWA(5173, dtype));
				ub1 = tb2;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5160, "set_error_report", loc2))(loc2, ub1x);
			}
			RTHOOK(9);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5161, "run_es_test", loc2))(loc2);
			RTHOOK(10);
			RTDBGAA(Current, dtype, 5171, 0x10000000, 1); /* number_of_tests */
			ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(5171, "number_of_tests", loc2));
			(*(EIF_INTEGER_32 *)(Current + RTWA(5171, dtype))) += ti4_2;
			RTHOOK(11);
			RTDBGAA(Current, dtype, 5172, 0x10000000, 1); /* number_passed_tests */
			ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(5172, "number_passed_tests", loc2));
			(*(EIF_INTEGER_32 *)(Current + RTWA(5172, dtype))) += ti4_2;
			RTHOOK(12);
...
#define ui4_1 ui4_1x.it_i4
	...
	if (EIF_TEST(loc1)) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(4,1);
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5167, "passed_cases", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr2);
...
#define ui4_1 ui4_1x.it_i4
	...
	if (EIF_TEST(loc1)) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(4,1);
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5168, "failed_cases", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr2);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2375, "append", Result))(Result, ur1x);
			RTHOOK(5);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3147, "forth", loc2))(loc2);
...
/* {ES_SUITE}.make_test */
void F976_7424 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F976_7426 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_r
	...
	RTCC(arg3, 975, l_feature_name, 3, RTWCT(5205, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5173, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5173, dtype)) = (EIF_BOOLEAN) arg1;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(5174, dtype)) = (EIF_BOOLEAN) arg2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5205, 0xF80000E8, 0); /* name */
	tr1 = RTCCL(arg3);
	RTAR(Current, tr1);
