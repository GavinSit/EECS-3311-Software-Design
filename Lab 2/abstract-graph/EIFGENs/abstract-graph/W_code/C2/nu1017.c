/*
 * Code for class NUMERIC_ITERABLE [G#1]
 */
...
extern EIF_TYPED_VALUE F1017_7236(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1017_7236 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1016, Current, 1, 2, 13537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 13537);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,257,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5026, dtype, Dftype(Current));
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1018,0xFF01,0xFFF9,1,186,0,0,218,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5026, dtype, Dftype(Current));
