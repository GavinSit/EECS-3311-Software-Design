...
extern void F984_7573(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F984_7574(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_7575(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_7576(EIF_REFERENCE);
...
void F984_7573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 983, Current, 0, 2, 13839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(983, Current, 13839);
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5332, 0xF8000383, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F984_7574 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 3, 0, 13840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(983, Current, 13840);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F984_7575 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 13841);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(983, Current, 13841);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F984_7576 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
