...
{
	GTCX
	RTOTC (F962_7245,13540,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F962_7250,13545,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F962_7251,13546,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F962_7252,13547,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
