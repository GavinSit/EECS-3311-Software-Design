...
static const struct desc_info desc_983[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13831, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13832, 41},
	{EIF_GENERIC(egt_14_983), 13833, 0},
	{EIF_GENERIC(egt_15_983), 13825, 8},
	{EIF_GENERIC(egt_16_983), 13826, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13827, 44},
	{EIF_GENERIC(egt_17_983), 13828, 24},
	{EIF_GENERIC(NULL), 13835, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_983), 13838, 32},
};
void Init983(void)
{
	IDSC(desc_983, 0, 982);
