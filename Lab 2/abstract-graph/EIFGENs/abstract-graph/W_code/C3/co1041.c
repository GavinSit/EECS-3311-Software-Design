/*
 * Code for class COMPARABLE_VERTEX_DISTANCE_PAIR [G#1]
 */
...
extern EIF_TYPED_VALUE F1041_7708(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {COMPARABLE_VERTEX_DISTANCE_PAIR}.is_less */
EIF_TYPED_VALUE F1041_7708 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1040, Current, 0, 1, 13970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1040, Current, 13970);
...
body:;
	...
	if ((EIF_BOOLEAN) (ti8_1 < ti8_2)) {
		...
		if ((EIF_BOOLEAN) (ti8_1 > ti8_2)) {
			...
			tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5418, "vertex", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr2);
