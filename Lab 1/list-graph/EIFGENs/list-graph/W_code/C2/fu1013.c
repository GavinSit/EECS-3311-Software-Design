...
extern EIF_TYPED_VALUE F1013_6499(EIF_REFERENCE);
extern void F1013_6500(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1013_6501(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1013_6502(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1013_6503(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1013_6504(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1013_6505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1013_6506(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1013_6507(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1013_6508(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F1013_6508
static EIF_INTEGER_32 inline_F1013_6508 (EIF_POINTER arg1, EIF_POINTER arg2, EIF_POINTER arg3, EIF_POINTER arg4, EIF_INTEGER_32 arg5, EIF_BOOLEAN arg6, EIF_INTEGER_32 arg7, EIF_INTEGER_32 arg8, EIF_INTEGER_32 arg9, EIF_POINTER arg10)
{
	#ifdef WORKBENCH
...
EIF_TYPED_VALUE F1013_6499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
/* {FUNCTION}.call */
void F1013_6500 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14138);
	RTCC(arg1, 1012, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
...
/* {FUNCTION}.item */
EIF_TYPED_VALUE F1013_6501 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1012, Current, 1, 1, 14139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FUNCTION}.apply */
void F1013_6502 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 0, 14140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FUNCTION}.is_equal */
EIF_TYPED_VALUE F1013_6503 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FUNCTION}.copy */
void F1013_6504 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {FUNCTION}.eval */
EIF_TYPED_VALUE F1013_6505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14143);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14143);
	RTCC(arg1, 1012, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x02);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
void F1013_6506 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1012, Current, 1, 0, 14144);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1013_6507 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1012, Current, 2, 1, 14145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		{
			...
			RTCC(arg1, 1012, l_feature_name, 1, typres0, 0x04);
		}
	}
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
...
/* {FUNCTION}.fast_item */
EIF_TYPED_VALUE F1013_6508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x, EIF_TYPED_VALUE arg8x, EIF_TYPED_VALUE arg9x, EIF_TYPED_VALUE arg10x)
{
	GTCX
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1012, Current, 0, 10, 14146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1012, Current, 14146);
	RTIV(Current, RTAL);
	Result = inline_F1013_6508 ((EIF_POINTER) arg1, (EIF_POINTER) arg2, (EIF_POINTER) arg3, (EIF_POINTER) arg4, (EIF_INTEGER_32) arg5, (EIF_BOOLEAN) arg6, (EIF_INTEGER_32) arg7, (EIF_INTEGER_32) arg8, (EIF_INTEGER_32) arg9, (EIF_POINTER) arg10);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
