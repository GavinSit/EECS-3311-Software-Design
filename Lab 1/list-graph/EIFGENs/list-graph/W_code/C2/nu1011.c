...
extern EIF_TYPED_VALUE F1011_7242(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1011_7242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1010, Current, 1, 2, 13543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1010, Current, 13543);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,257,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5032, dtype, Dftype(Current));
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1012,0xFF01,0xFFF9,1,186,0,0,218,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5032, dtype, Dftype(Current));
