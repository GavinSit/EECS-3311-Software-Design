...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 13550, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_963), 13551, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_963), 13552, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_963), 13545, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_963), 13546, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_963), 13549, 0xFFFFFFFF},
	{EIF_GENERIC(egt_19_963), 13547, 0xFFFFFFFF},
	{EIF_GENERIC(egt_20_963), 13548, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 411, 962);
}
